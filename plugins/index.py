    ...
    if message.from_user.id in ADMINS:
        if (LAZY_MODE==True):
            ...
            buttons = [
                ...
                [ InlineKeyboardButton("📸G͢e͢t͢ T͢h͢u͢m͢b͢n͢a͢i͢l͢ ᶜᵒᵐⁱⁿᵍ ˢᵒᵒⁿ", callback_data="getduduhumbnail") ],
    ...
    if (LAZY_MODE == True):
        if message.from_user.id in LAZY_RENAMERS:
            ...
            buttons = [
                        ...
                        [ InlineKeyboardButton("📸G͢e͢t͢ T͢h͢u͢m͢b͢n͢a͢i͢l͢ ᶜᵒᵐⁱⁿᵍ ˢᵒᵒⁿ", callback_data="reqauthgetduduhumbnail") ],
