...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            logger.error("ஏய் டூடூ,நான் சேனலில் சேர்க்கப்பட்டுள்ளேனா இல்லையா என்பதை ஒருமுறை சரிபார்க்கவும்.....!")
            return
        btn = [
            [
             ...
             [
                InlineKeyboardButton(
                    "Ullu Movies 🔞", url='https://t.me/+wSKok4_ByB0yM2E9'
                )
            ]
        ]
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You MR.Kinh ♥️')
